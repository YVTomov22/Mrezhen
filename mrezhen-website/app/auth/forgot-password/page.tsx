    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-md shadow-2xl border-border bg-card/80 backdrop-blur-xl">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-3xl font-extrabold tracking-tight">{t("forgotTitle")}</CardTitle>
          <CardDescription className="text-muted-foreground">{t("forgotDescription")}</CardDescription>
        </CardHeader>
